  ...
  return (
    <group position={[0, 0, 0]}>
      <mesh ref={mesh}>
        ...
        <meshStandardMaterial color="#5e6ad2" transparent opacity={0.15} roughness={0.1} metalness={0.8} />
      </mesh>
      <mesh ref={wireframe}>
        <torusKnotGeometry args={[1.2, 0.4, 32, 8]} />
        <meshBasicMaterial color="#7170ff" wireframe transparent opacity={0.25} />
      </mesh>
    </group>
  )
}
...
function FloatingParticles() {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < count; i++) {
      dummy.position.set((Math.random() - 0.5) * 25, (Math.random() - 0.5) * 25, (Math.random() - 0.5) * 15)
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50" style={{
        ...
        <div className="max-w-[1100px] mx-auto h-16 flex items-center justify-between px-5 md:px-12">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="#preco" className="text-[14px] font-medium text-gray-500 hover:text-black transition-colors">Preco</a>
            <a href="#contato" className="text-[14px] font-semibold px-5 py-2.5 rounded-lg bg-black text-white hover:opacity-80 transition-all hover:scale-[1.02]">Comecar agora</a>
          </div>
        </div>
      </nav>

      {/* ═══════════════════════════════════════════════════════════════
          HERO — Dor > Solução > CTA
      ═══════════════════════════════════════════════════════════════ */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-[800px] mx-auto px-5 text-center" style={{ transform: `translateY(${scrollY * -0.2}px)` }}>
          <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full mb-10" style={{
            ...
            border: '1px solid rgba(255,255,255,0.8)', boxShadow: '0 4px 16px rgba(0,0,0,0.04)',
          ...
          <h1 className="text-[clamp(38px,7vw,68px)] font-bold leading-[1.02] tracking-[-3px] mb-7" style={{ animation: 'fadeInUp 0.7s ease-out 0.1s both' }}>
            Voce perde 3h por dia<br />em tarefas repetitivas.<br />
          ...
          <p className="text-[18px] md:text-[20px] text-gray-500 leading-[1.7] max-w-[560px] mx-auto mb-11" style={{ animation: 'fadeInUp 0.7s ease-out 0.2s both' }}>
            O Hermes e um assistente IA que roda num servidor, se conecta com seu <strong className="text-gray-700">WhatsApp, email e calendario</strong>, e executa tarefas reais por voce. Nao e so um chatbot que responde — ele <strong className="text-gray-700">faz</strong>.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap" style={{ animation: 'fadeInUp 0.7s ease-out 0.3s both' }}>
            ...
            <a href="#como-funciona" className="px-7 py-3.5 rounded-xl text-[15px] font-medium text-gray-600 hover:text-black transition-all duration-300 hover:scale-[1.02]" style={{
              background: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(12px)', border: '1px solid rgba(0,0,0,0.08)',
            }}>
              Como funciona
            </a>
          </div>
      ...
      <section id="como-funciona" className="max-w-[1100px] mx-auto px-5 md:px-12 py-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            { step: '2', title: 'O Hermes entende e executa', desc: 'Ele ta rodando num servidor, conectado com suas ferramentas. Leu seus emails, gerenciou seu WhatsApp, agendou sua reuniao. Tudo automatico.' },
            ...
            <RevealSection key={item.step} delay={i * 0.12}>
              <div className="relative p-8 rounded-[16px] transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/[0.04]" style={{
                background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(16px)',
                border: '1px solid rgba(255,255,255,0.8)', boxShadow: '0 4px 16px rgba(0,0,0,0.03)',
              }}>
      ...
      {/* ═══════════════════════════════════════════════════════════════
          DEMO — Conversa real no Telegram
      ═══════════════════════════════════════════════════════════════ */}
          ...
          <RevealSection>
            <div>
              ...
              <h2 className="text-[clamp(26px,4vw,40px)] font-bold tracking-[-1.5px] mb-5 leading-tight">
                Nao e um chatbot que<br />responde "oi, como vai?".<br />
                <span className="gradient-text">Ele faz as coisas.</span>
              </h2>
              <div className="space-y-4 mt-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 text-[15px] text-gray-600">
                    <span className="text-[18px]">{ex.icon}</span> {ex.text}
                  </div>
                ))}
              </div>
          ...
          <RevealSection delay={0.15}>
            <div className="relative">
              ...
              <div className="relative rounded-[16px] overflow-hidden" style={{
                ...
                border: '1px solid rgba(255,255,255,0.9)', boxShadow: '0 24px 48px rgba(0,0,0,0.08), 0 0 0 1px rgba(0,0,0,0.02)',
              }}>
                ...
                <div className="p-5 space-y-3.5 min-h-[340px]" style={{ background: 'rgba(255,255,255,0.5)' }}>
                  ...
                  <div className="tg-msg tg-bot">
                    ...
                    • Pedro (Nubank) — proposta pendente, pediu ajuste no valor<br/>
                    • Maria (Agencia) — quer reuniao terca 14h<br/>
                    • 2 spam ignorados automaticamente<br/><br/>
                    Quer que eu responda o Pedro?
                  </div>
                  <div className="tg-msg tg-user">Sim, manda que vou aceitar o valor original</div>
                  <div className="tg-msg tg-bot">
                    ✓ Email enviado pro Pedro com aceite<br/>
                    ✓ Lembrete criado: reuniao Maria, terca 14h<br/>
                    ✓ Follow-up automático em 24h se nao responder
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-12">
          <RevealSection>
            <div className="mb-12">
              ...
              <p className="text-[17px] text-gray-500">Voce ja paga R$100/mes no ChatPPT Plus. Pra que, se ele so responde?</p>
            </div>
          </RevealSection>
          <RevealSection delay={0.1}>
            <div className="rounded-[16px] overflow-hidden" style={{
              background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(16px)',
              border: '1px solid rgba(255,255,255,0.8)', boxShadow: '0 8px 32px rgba(0,0,0,0.04)',
            }}>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={i} style={{ borderBottom: '1px solid rgba(0,0,0,0.04)' }}>
                      <td className="p-5 text-gray-600 font-medium">{label as string}</td>
        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-12">
          <RevealSection>
            <div className="mb-14 text-center">
              ...
              <h2 className="text-[clamp(26px,4vw,40px)] font-bold tracking-[-1.5px] mb-3">Paga uma vez. Usa pra sempre.</h2>
              <p className="text-[17px] text-gray-500">Sem mensalidade. Sem surpresa. Setup completo em 24h.</p>
            </div>
          </RevealSection>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { name: 'Basico', price: 'R$500', desc: 'Pra quem quer testar', features: ['Instalacao completa', '3 integracoes (WhatsApp, email, calendario)', 'Suporte 7 dias'], cta: 'Comecar', featured: false },
              { name: 'Profissional', price: 'R$2.000', desc: 'O mais vendido', features: ['Integracoes ilimitadas', 'Automacoes sob medida', 'WhatsApp automatizado', 'Suporte 30 dias'], cta: 'Melhor custo-beneficio', featured: true },
              { name: 'Empresa', price: 'R$5.000', desc: 'Pra equipes e escritorios', features: ['Multi-usuario', 'Integracoes ilimitadas', 'Treinamento da equipe', 'Suporte prioritario'], cta: 'Falar com vendas', featured: false },
            ].map((p, i) => (
        ...
        <div className="relative max-w-[600px] mx-auto px-5 text-center">
          <RevealSection>
            <h2 className="text-[clamp(26px,5vw,44px)] font-bold tracking-[-1.5px] mb-5 leading-tight">
              Amanha voce acorda<br/>e o Hermes ja trabalhou<br/><span className="gradient-text">a noite inteira por voce.</span>
            </h2>
            <p className="text-[17px] text-gray-500 mb-10 leading-relaxed">
              Setup completo em 24h. Sem mensalidade. Paga uma vez, usa pra sempre.
            </p>
